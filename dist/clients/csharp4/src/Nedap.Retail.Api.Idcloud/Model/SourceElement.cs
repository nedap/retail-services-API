...
namespace Nedap.Retail.Api.Idcloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SourceElement :  IEquatable<SourceElement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SourceElement" /> class.
        /// </summary>
        /// <param name="Type">See EPCIS version 1.1.</param>
        /// <param name="Source">See EPCIS version 1.1.</param>
        public SourceElement(string Type = default(string), string Source = default(string))
        {
            this.Type = Type;
            this.Source = Source;
        }
        ...
        /// <summary>
        /// Returns true if SourceElement instances are equal
        /// </summary>
        /// <param name="other">Instance of SourceElement to be compared</param>
        /// <returns>Boolean</returns>

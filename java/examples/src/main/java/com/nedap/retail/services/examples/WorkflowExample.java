...
public class WorkflowExample {
    ...
    public static void runExample(final Client client) {
        System.out.println(PrintHelper.NEW_LINE + "*** Workflow API example ***");

        final String locationId = client.getSites().get(0).getId();

        try {
            // Make some EPCIS events first
            System.out.println(PrintHelper.NEW_LINE + "Capturing some EPCIS events first...");
            ...
            // Workflow capture
            System.out.println(PrintHelper.NEW_LINE + "Capturing workflow event...");
            ...
            System.out.println(PrintHelper.NEW_LINE + "--- Workflow API example finished ---");
    ...
    private static String printWorkflow(final WorkflowEvent workflow) {
        ...
        sb.append(PrintHelper.NEW_LINE + PrintHelper.TAB + "Type: " + workflow.getType());
        sb.append(PrintHelper.NEW_LINE + PrintHelper.TAB + "Event time: " + workflow.getEventTime());
        sb.append(PrintHelper.NEW_LINE + PrintHelper.TAB + "Location: " + workflow.getLocation());
        sb.append(PrintHelper.NEW_LINE + PrintHelper.TAB + "Epc count: " + workflow.getEpcCount());
        sb.append(PrintHelper.NEW_LINE + PrintHelper.TAB + "Message ids: ");
    ...
    private static String printWorkflowEvents(final List<WorkflowEvent> workflowEvents) {
        ...
        for (int i = 0; i < workflowEvents.size(); i++) {
            ...
            sb.append("Workflow event " + (i + 1) + PrintHelper.DOT);

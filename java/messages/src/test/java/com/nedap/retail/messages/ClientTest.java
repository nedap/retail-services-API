...
public class ClientTest {
    ...
    // private static final String URL = "https://api-test.nedapretail.com";
    //
    // private static Client client;
    //
    // @Path(URL)
    // public static class TestResource {
    // @Path("/article/v2/quantity")
    // @GET
    // public Long articleQuantity() {
    // return 5L;
    // }
    //
    // @Path("/article/v2/retrieve")
    // @GET
    // public List<Article> articleDetailsByGtins(@QueryParam("gtins") final String gtins) {
    ...
    //
    // @Test
    // public void test_article_quantity() {
    // final Long test = target(URL + "/article/v2/quantity").request().get(Long.class);
    // assertEquals(5, test.intValue());
    // }
    //
    // @Test
    // public void test_article_details_by_gtins() {
    // final List<Article> test = target(URL + "/article/v2/retrieve" + "?gtins=111").request().get(

...
public abstract class AbstractClient {
    ...
    public AbstractClient(final String url) {
        this.url = url;
    ...
    public AbstractClient(final String url, final com.sun.jersey.api.client.Client httpClient) {
        this.url = url;
    ...
    public String getLocationsFromOrganizationId(final Long organizationId)
